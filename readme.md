...
<h4 align="center">Scraping & Analyzing Ready Made Clothes from <a href="https://www.thereyougo.in/" target="_blank">There You Go</a> website with <a href="https://en.wikipedia.org/wiki/Python_(programming_language)" target="_blank">Python</a> and <a href="https://en.wikipedia.org/wiki/Microsoft_Power_BI" target="_blank">Power BI</a></h4>
...
[There You Go][website_link] is a brand with boutique services that introduces a new way of shopping for ready made clothes to ensure maximum customer services.

This project focuses on scraping all the available clothes available in [There You Go][website_link] website, performing exploratory data analysis to generate insights and visualize them with the help of Power BI.

The repository directory structure is as follows:

ThereYouGo-Store-Analysis<br>
├─ 01_WEBSCRAPING<br>
├─ 02_ETL<br>
├─ 03_DATA<br>
├─ 04_ANALYSIS<br>
...
[website_link]: https://www.thereyougo.in/
